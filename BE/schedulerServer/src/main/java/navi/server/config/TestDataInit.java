...
public class TestDataInit {
    ...
    public void init(){
        ...
        schedulerService.createAnnouncementSchedule(find,new AddingAnDTO("23213993","test.com","테스트","테스트내용","2020-03-03","2020-04-05"));
        ...
        schedulerService.createSpecialSchedule(find,new AddingSpDTO("Opic","2020-10-12","2020-11-01","2020-09-01","2020-10-11"));
        schedulerService.createSpecialSchedule(find,new AddingSpDTO("Toeic","2020-4-01","2020-04-07","2020-02-01","2020-03-11"));
